...
function alignitems($value = '', $isimportant = false)
{
 ...
 function gridautocolumns($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'grid-auto-columns:'.$value.' !important;';
     } else {
         return 'grid-auto-columns:'.$value.';';
     }
 }

 function gridautoflow($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'grid-auto-flow:'.$value.' !important;';
     } else {
         return 'grid-auto-flow:'.$value.';';
     }
 }

 function gridautorows($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'grid-auto-rows:'.$value.' !important;';
     } else {
         return 'grid-auto-rows:'.$value.';';
     }
 }

 function gridcolumn($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'grid-column:'.$value.' !important;';
     } else {
 ...
 function maskrepeat($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'mask-repeat:'.$value.' !important;';
     } else {
         return 'mask-repeat:'.$value.';';
     }
 }

 function masksize($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'mask-size:'.$value.' !important;';
     } else {
         return 'mask-size:'.$value.';';
     }
 }
 ...
 function paddingtop($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'padding-top:'.$value.' !important;';
     } else {
 ...
 function pagebreakafter($value = '', $isimportant = false)
 {
     if ($isimportant) {
         return 'page-break-after:'.$value.' !important;';
     } else {
         return 'page-break-after:'.$value.';';
     }
 }
...
function firstchild($value,$othervalue ='',$properties =[]){
    if (is_array($properties)) {
    } else {
        $properties = [$properties];
    }
    $tag = $value.':first-child '.$othervalue.'{';
    $tag .= implode('', $properties);
...
function firstoftype($value,$othervalue ='',$properties =[]){
    if (is_array($properties)) {
    } else {
        $properties = [$properties];
    }
    $tag = $value.':first-of-type '.$othervalue.'{';
    $tag .= implode('', $properties);
...
function focus($value,$othervalue ='',$properties =[]){
    if (is_array($properties)) {
    } else {
        $properties = [$properties];
    }
    $tag = $value.':focus '.$othervalue.'{';
    $tag .= implode('', $properties);
...
function inrange($value,$othervalue ='',$properties =[]){
    if (is_array($properties)) {
    } else {
        $properties = [$properties];
    }
    $tag = $value.':in-range '.$othervalue.'{';
    $tag .= implode('', $properties);
...
function invalid($value,$othervalue ='',$properties =[]){
    if (is_array($properties)) {
    } else {
        $properties = [$properties];
    }
    $tag = $value.':invalid '.$othervalue.'{';
    $tag .= implode('', $properties);
